...
public class RecitationProgram extends JFrame implements ActionListener
{
    ...
    private JMenuItem mNegate;
    private JMenuItem mIncrease;
    private JMenuItem mDecrease; 
    private JLabel    mLabel;
    
    // P11.java object from student
    private RecitationInterface mStudent;
    ...
    protected void doAction (ActionEvent actionEvent) throws Exception {
        ...
        else if (src == mNegate)    	negate();
        else if (src == mIncrease) 		increase();
        else if (src == mDecrease)    	decrease();
    }
    ...
    protected JMenu makeActionMenu() {
        ...
        mNegate     = makeMenuItem(menu, "Negate"     , 'N');
        mIncrease	= makeMenuItem(menu, "Increase"   , 'I');
        mDecrease   = makeMenuItem(menu, "Decrease"   , 'D');
        return menu;
    }
    ...
    public static void main (String[] args) throws IOException {
        RecitationProgram gui = new RecitationProgram();
        gui.setVisible(true);
    }
}
